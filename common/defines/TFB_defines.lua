...
NDefines.NGame.GAME_SPEED_SECONDS = { 0.5, 0.3, 0.17, 0.1, 0.00 } -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NDefines.NProduction.MIN_FIELD_TO_TRAINING_MANPOWER_RATIO = 1000	-- Ratio which % of army in field can be trained
NDefines.NProduction.INFRA_MAX_CONSTRUCTION_COST_EFFECT = 1.0 		-- Building in a state with higher infrastructure will reduce the cost of shared buildings.
...
NDefines.NTechnology.BASE_TECH_COST = 120					-- Base cost for a tech. multiplied with tech cost and ahead of time penalties
...
NDefines.NMilitary.TRAINING_EXPERIENCE_SCALE = 0.0
...
NDefines.NMilitary.TRAINING_ATTRITION = 0.00		  			   -- amount of extra attrition from being in training
